...
WebUI.click(findTestObject('Page_CURA Healthcare Service/td_12'))
...
WebUI.verifyElementText(findTestObject('Page_CURA Healthcare Service/p_Hongkong CURA Healthcare Center'), 'Tokyo CURA Healthcare Center')
