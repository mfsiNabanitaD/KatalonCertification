...
WebUI.mouseOver(findTestObject('Object Repository/Page_OrangeHRM/p_Punched In'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Page_OrangeHRM/div_16h 48m Today'))
